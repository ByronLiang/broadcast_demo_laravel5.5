...
namespace Modules\Follow\Entities\Traits;

use Modules\Follow\Entities\Follow;
use Modules\Follow\Entities\Followable;
...
trait CanBeLiked
{
    ...
    {
        return $this->morphOne(Followable::class, 'followable')->where('relation', Follow::RELATION_LIKE);
    }
}
